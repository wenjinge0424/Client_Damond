...
public class MapPoliceFragment extends Fragment implements OnMapReadyCallback {
    public static MapPoliceFragment instance;
    MainActivity mActivity;
    GoogleMap googleMap;
    SupportMapFragment mapFragment;

    public static MapPoliceFragment newInstance() {
        MapPoliceFragment fragment = new MapPoliceFragment();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_map_police, container, false);
    ...
    private void showMap() {
        if (googleMap != null) {
            ...
            pointOption.icon(BitmapDescriptorFactory.fromResource(R.mipmap.map_marker));
