...
public class RequestPatrolFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_request_patrol, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_create_request:
                Navigation.findNavController(v).navigate(R.id.action_RequestFragment_to_RPCT);
                break;
        }
    }
